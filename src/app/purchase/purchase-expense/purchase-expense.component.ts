...
@Component({
  selector: 'app-purchase-expense',
  templateUrl: './purchase-expense.component.html',
  styleUrls: ['./purchase-expense.component.css'],
  providers: [NgbInputDatepickerConfig]
})
export class PurchaseExpenseComponent implements OnInit {

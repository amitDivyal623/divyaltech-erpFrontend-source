...
@Component({
  selector: 'app-purchase-material',
  templateUrl: './purchase-material.component.html',
  styleUrls: ['./purchase-material.component.css'],
  providers: [NgbInputDatepickerConfig]
})
export class PurchaseMaterialComponent implements OnInit {

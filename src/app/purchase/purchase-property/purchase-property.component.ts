...
@Component({
  selector: 'app-purchase-property',
  templateUrl: './purchase-property.component.html',
  styleUrls: ['./purchase-property.component.css'],
  providers: [NgbInputDatepickerConfig]
})
export class PurchasePropertyComponent implements OnInit {

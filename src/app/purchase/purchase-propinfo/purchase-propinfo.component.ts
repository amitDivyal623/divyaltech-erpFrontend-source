...
@Component({
  selector: 'app-purchase-propinfo',
  templateUrl: './purchase-propinfo.component.html',
  styleUrls: ['./purchase-propinfo.component.css'],
  providers: [NgbInputDatepickerConfig]
})
export class PurchasePropinfoComponent implements OnInit {

...
@Component({
  selector: 'app-edit-property-sale',
  templateUrl: './edit-property-sale.component.html',
  styleUrls: ['./edit-property-sale.component.css']
})
export class EditPropertySaleComponent implements OnInit {

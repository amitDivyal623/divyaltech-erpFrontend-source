...
@Component({
  selector: 'app-hr-machine-attendance',
  templateUrl: './hr-machine-attendance.component.html',
  styleUrls: ['./hr-machine-attendance.component.scss']
})
export class HrMachineAttendanceComponent implements OnInit, OnDestroy {
	...
	DatatableParameter = { dateTo: '', dateFrom : '',vendorname: '',CompanyId: '',ResourceType :'', attendanceType: ''};
	...
	datatableCode() {
		...
		this.DatatableParameter.attendanceType = '1';
		...
		this.dtOptions = {
			...
			ajax: (dataTablesParameters: any, callback) => {
				...
				that.http.post<DataTablesResponse>(environment.APIEndpoint+'salary.fetchMachineAttandance&reload=1',Object.assign(dataTablesParameters,this.DatatableParameter), {responseType: 'json', headers}).pipe(takeUntil(this.destroy$)).subscribe(resp =>{

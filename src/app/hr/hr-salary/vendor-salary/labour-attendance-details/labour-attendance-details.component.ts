...
@Component({
	selector: 'app-labour-attendance-details',
	templateUrl: './labour-attendance-details.component.html',
	styleUrls: ['./labour-attendance-details.component.css']
})
export class LabourAttendanceDetailsComponent implements OnInit, OnDestroy {
	...
	DatatableParameter = { dateTo: '', dateFrom : '',vendorname: '',CompanyId: '',ResourceType :''};
	...
	datatableCode() {
		...
		this.dtOptions = {
			...
			ajax: (dataTablesParameters: any, callback) => {
				...
				that.http.post<DataTablesResponse>(environment.APIEndpoint+'salary.fetch_vendorattendance&reload=1',Object.assign(dataTablesParameters,this.DatatableParameter), {responseType: 'json', headers}).pipe(takeUntil(this.destroy$)).subscribe(resp =>{
